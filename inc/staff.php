<div id="main-wrapper"><div id="main" class="clearfix">
      ...
      <div id="content" class="column"><div class="section">
        <a id="main-content"></a>
                <h1 class="title" id="page-title">Staff</h1>                <div class="tabs"></div>                          <div class="region region-content">
    <div id="block-system-main" class="block block-system">

    
  <div class="content">
    <article id="node-810" class="node node-page clearfix">
  ...
  <div class="content">
	...
	<tbody>
		...
		<tr class="with--img">
			...
			<td><strong>Tamásné Fehér</strong><br>
			accountant</td>
			<td>&nbsp;</td>
		</tr>
		<tr class="with--title">
		...
		<tr>
			<td><strong>Anna Csongor</strong><br>
			sociologist, teacher, board member of the Hungarian Foundation for Self-Reliance</td>
			<td><strong>Réka Fodor</strong><br>
			master of horticultural sciences, auditor of the Tax and Economic Consultancy Ltd.</td>
			<td>&nbsp;</td>
		</tr>
		<tr class="with--title">
			<td colspan="3">
			<h2>Our former colleagues, helpers and supporters</h2>
			</td>
		</tr>
  ...
  <ul class="links inline"><li class="translation_hu first last"><a href="/munkatarsaink" title="Munkatársaink" class="translation-link" lang="hu">Magyar</a></li>
</ul>
